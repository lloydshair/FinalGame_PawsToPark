...
public class BabyFinal : MonoBehaviour
{
    ...
    //hiding
    private FinalHAM2 playerMovement;
    //animation 
    ...
    void Start()
    {
        ...
        //hiding
        playerMovement = FindObjectOfType<FinalHAM2>();
        agent = GetComponent<NavMeshAgent>();
        //animation
        if (animator == null)
        {
    ...
    void Update()
    {
        ...
        animator.SetFloat("Horizontalss", movementDirection.x);
        animator.SetFloat("Verticalss", movementDirection.y);
        animator.SetFloat("speedss", movementDirection.sqrMagnitude);
